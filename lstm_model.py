...
pyplot.show()
df
timeseries = df[["Monthly beer production"]].values.astype('float32')
...
# plot
pyplot.plot(timeseries, c='b')
pyplot.plot(train_plot, c='r')
pyplot.plot(test_plot, c='g')
pyplot.show()
